...
class LandmarkWindow(AbstractWindow):
    ...
    def forget(self):
        ...
        if self.forgetting_strategy is not None:
            ...
            data_remaining = data_to_drop.drop(index=data_to_drop.index.levels[0], inplace=False, level=0)
